...
# domain_specific_model_pipeline documentation build
...
from domain_specific_model_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "domain_specific_model_pipeline"
author = "Kedro"
...
htmlhelp_basename = "domain_specific_model_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "domain_specific_model_pipeline.tex",
        "domain_specific_model_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "domain_specific_model_pipeline",
        "domain_specific_model_pipeline Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "domain_specific_model_pipeline",
        "Project domain_specific_model_pipeline codebase.",
        "Data-Science",
    )
]
